...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "packageRegistryData": [
      ...
      ["deep-extend", [
        ["npm:0.5.1", {
          "packageLocation": "./.yarn/cache/deep-extend-npm-0.5.1-b353334103-009c1b0fcb.zip/node_modules/deep-extend/",
          "packageDependencies": [
      ...
      ["twitter", [
        ["npm:1.7.1", {
          "packageLocation": "./.yarn/cache/twitter-npm-1.7.1-218532ebf8-8dbaedfb3d.zip/node_modules/twitter/",
          "packageDependencies": [
            ["twitter", "npm:1.7.1"],
            ["deep-extend", "npm:0.5.1"],
            ["request", "npm:2.88.2"]
